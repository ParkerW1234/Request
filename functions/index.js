...
exports.updateRequestStatus = functions.https.onRequest(async (req, res) => {
  ...
  res.set("Access-Control-Allow-Origin", "https://parkerw1234.github.io/Request/"); // Line 17 - Kept short
  ...
  try {
    ...
    const teacherUid = [
        'jAHeiVc2nZSdf44WTDJEUYPhSGp2', // Replace with Scortina's UID
        'kIpI37Q4bqbgGt5KUYslHA8xtOu2', // Replace with the new teacher's UID
